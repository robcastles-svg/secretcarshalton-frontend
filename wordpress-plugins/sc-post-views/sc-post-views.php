...
define( 'SC_POST_VIEWS_VERSION', '0.2.0' );
...
/** One-time: give every existing event/listing its 10-view starting baseline (see EVENT_LISTING_BASELINE_VIEWS). */
add_action(
	'plugins_loaded',
	function () {
...
/** Same baseline for every event/listing published from now on, not just the ones that already existed. */
add_action(
